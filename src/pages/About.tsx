          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 animate-fade-in">
              <h1 className="text-4xl lg:text-5xl font-bold text-navy">
                About <span className="text-cyan">GlobalTrade Exports</span>
              </h1>
              <p className="text-lg text-gray-600 leading-relaxed">
                With over 15 years of experience in international trade, we've built a reputation 
                as a trusted partner for businesses looking to expand their global reach. Our expertise 
                spans across logistics, customs handling, and trade consultation.
              </p>
            </div>
            <div className="animate-slide-in">
              <img src="https://images.unsplash.com/photo-1605810230434-7631ac76ec81?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Global Trade Team" className="w-full h-96 object-cover rounded-2xl shadow-custom-lg" />
            </div>
          </div>
        </div>
      </section>
