        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="border-gray-200 focus:border-cyan focus:ring-cyan rounded-lg"
              />
            </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className="border-gray-200 focus:border-cyan focus:ring-cyan rounded-lg resize-none"
            />
          </div>
